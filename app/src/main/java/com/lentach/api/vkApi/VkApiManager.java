...
public class VkApiManager {
    ...
    public  void addLikeToPost(Context context, final onAddLikesResult listener, final onAddLikesResultFail listenerFail, int postId){
        ...
        addLikeRequest.executeWithListener(new VKRequest.VKRequestListener() {
            ...
            public void onError(VKError error) {
                ...
                listenerFail.onAddLikesResultFail(error.errorMessage);
    ...
    public  void deleteLikeFromPost(Context context, final onAddLikesResult listener, final onAddLikesResultFail listenerFail ,int postId){
    ...
    public static interface onAddLikesResultFail {
