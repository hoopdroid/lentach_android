...
import com.lentach.ui.adapters.CommentsRVAdapter;
import com.lentach.util.CommentsComporator;
...
public class PostCommentsFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
        ...
        if(VKAccessToken.currentToken()==null) {
            ...
            mAuthBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ActivityRouter.startVKPermissionActivity(getActivity());
                }
            });
        }
        else{
    ...
    private void getCommentsData() {
        ...
        DataService.init().getCommentsFromWallPost(getActivity(),new DataService.onRequestCommentsResult() {
            @Override
